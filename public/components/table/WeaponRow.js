class WeaponRow extends React.Component {
  ...
  onParamChange(event) {
    this.props.onParamChange(
        ...
        event.target.id == 'name' ?
          event.target.value :
          this.sanitizeDiceExpr(event.target.value),
    );
  }
  ...
  countActiveOptions() {
    let count = 0;
    Object.entries(this.props.params['options'+this.props.id])
        .forEach(([key, value]) => {
          if (value != '') {
            count += 1;
          }
  ...
  render() {
    if (this.props.visible) {
      const activeOptionsCount = this.countActiveOptions();
      return <tbody>
        <tr className="datasheet-body">
          <th><button className="logo-btn" onClick={(event) => {
            this.props.onDelete(this.props.id);
          }}><i className="fa fa-trash"></i></button> {this.props.rank}&nbsp;
          <input
            maxLength="32"
            id="name"
            type="text"
          ...
          <th>
            ...
            <i className={
              ...
              &nbsp;({activeOptionsCount}
                &nbsp;{this.props.lang == 'en' ?
                  'active' :
                  (activeOptionsCount > 1 ? 'actives' : 'active')
              }
              )
            </i>
          </th>
        ...
        <div id={'options-menu' + this.props.id} className="w3-modal">
          <div className="w3-modal-content">
            <header className="w3-container shop-bg datasheet-header">
              ...
              {this.props.rank} -&nbsp;
              {this.props.params['name'+this.props.id]} -&nbsp;
              {activeOptionsCount}&nbsp;
              {activeOptionsCount <= 1 ?
                (this.props.lang == 'en' ? 'active option' : 'option active') :
            ...
            <div className="w3-container shop">
              ...
              <IsBlastOptionInput
                ...
                value={this.props.params['options'+this.props.id]['is_blast']}
              />
              <h3>{this.props.lang == 'en' ? 'Hits' : 'Touches'}</h3>
              <HitModifierOptionInput
                lang={this.props.lang}
                onOptionChange={this.onOptionChange}
                value={
                  this.props.params['options'+this.props.id]['hit_modifier']
                }
              />
              <RerollHitsOptionInput
                lang={this.props.lang}
                onOptionChange={this.onOptionChange}
                value={
                  this.props.params['options'+this.props.id]['reroll_hits']
                }
              />
              <AutoHitOptionInput
                lang={this.props.lang}
                onOptionChange={this.onOptionChange}
                value={this.props.params['options'+this.props.id]['auto_hit']}
              />
              <Dakka3OptionInput
                lang={this.props.lang}
                onOptionChange={this.onOptionChange}
                value={this.props.params['options'+this.props.id]['dakka3']}
              />
              <HitExplodesOptionInput
                lang={this.props.lang}
                onOptionChange={this.onOptionChange}
                value={
                  this.props.params['options'+this.props.id]['hit_explodes']
                }
              />
              <AutoWoundsOnOptionInput
                lang={this.props.lang}
                onOptionChange={this.onOptionChange}
                value={
                  this.props.params['options'+this.props.id]['auto_wounds_on']
                }
              />
              <h3>{this.props.lang == 'en' ? 'Wounds' : 'Blessures'}</h3>
              <WoundModifierOptionInput
                lang={this.props.lang}
                onOptionChange={this.onOptionChange}
                value={
                  this.props.params['options'+this.props.id]['wound_modifier']
                }
              />
              <RerollWoundsOptionInput
                lang={this.props.lang}
                onOptionChange={this.onOptionChange}
                value={
                  this.props.params['options'+this.props.id]['reroll_wounds']
                }
              />
              <SnipeOptionInput
                lang={this.props.lang}
                onOptionChange={this.onOptionChange}
                value={this.props.params['options'+this.props.id]['snipe']}
              />
              <WoundsBy2D6OptionInput
                lang={this.props.lang}
                onOptionChange={this.onOptionChange}
                value={
                  this.props.params['options'+this.props.id]['wounds_by_2D6']
                }
              />
              <h3>{this.props.lang == 'en' ? 'Saves' : 'Sauvegardes'}</h3>
              <SaveModifierOptionInput
                lang={this.props.lang}
                onOptionChange={this.onOptionChange}
                value={
                  this.props.params['options'+this.props.id]['save_modifier']
                }
              />
              <h3>{this.props.lang == 'en' ? 'Damages' : 'Dommages'}</h3>
              <RerollDamagesOptionInput
                lang={this.props.lang}
                onOptionChange={this.onOptionChange}
                value={
                  this.props.params['options'+this.props.id]['reroll_damages']
                }
              />
              <RollDamagesTwiceOptionInput
                lang={this.props.lang}
                onOptionChange={this.onOptionChange}
                value={
                  this.props.params
            ...
            <footer>
              <button
                ...
                {this.props.lang == 'en' ? 'Save & Close' : 'Sauvegarder'}
              </button>
            </footer>
          </div>
        </div>
  ...
  render() {
    return (
      <i
        ...
        style={this.props.value != '' ? {} : {visibility: 'hidden'}}>
      </i>
    );
  }
}
    ...
    return (
      <div
        ...
        <select
          ...
          onChange={(event) =>
            this.props.onOptionChange(event.target.id, event.target.value)
          }>
  ...
  render() {
    return (
      <div
        ...
        <Check value={this.props.value}/>&nbsp;
        {this.props.lang == 'en' ?
          'An unmodified hit roll of' :
          'Un jet de touche non modifié de'}&nbsp;
        <select
          id="dakka3"
          className="w3-select opt-select"
          name="option"
  ...
  render() {
    return (
      <div
        ...
        {this.props.lang == 'en' ?
          'always hits and automatically wounds' :
          'touche toujours et blesse automatiquement'}
      </div>
    );
  }
}
  ...
  render() {
    return (
      <div
        ...
        <Check value={this.props.value}/>&nbsp;
        {this.props.lang == 'en' ?
          'Wounds if the result of 2D6 is' +
          ' greater or equal to target’s Toughness' :
          'Blesse si le résultat de 2D6 est supérieur' +
          ' ou égal à l\'Endurance de la cible'}:
        <select
          id="wounds_by_2D6"
          className="w3-select opt-select"
          name="option"
  ...
  render() {
    return (
      <div
        ...
        <Check value={this.props.value}/>&nbsp;
        {this.props.lang == 'en' ?
          'Roll random damages twice and discard the lowest result':
          'Jetez deux dés pour infliger les dégâts et défausser' +
          ' le résultat le plus bas'
        }:&nbsp;
        <select
          id="roll_damages_twice"
          className="w3-select opt-select"
          name="option"
          value={this.props.value}
          onChange={(event) =>
...
class SnipeOptionInput extends React.Component {
  ...
  collapseState() {
    if (this.state.roll_type == '' ||
      this.state.threshold == '' ||
      this.state.n_mortals == '') {
      // Each param has to be entered to activate option
      return '';
    } else {
      return this.state.roll_type +
        ',' +
        this.state.threshold +
        ',' +
        this.state.n_mortals;
  ...
  render() {
    return (
      <div
        className={'opt-' + (this.props.value != '' ? 'active' : 'inactive')}>
        <Check value={this.props.value}/>&nbsp;
        {this.props.lang == 'en' ? 'Each' : 'Chaque jet de'}&nbsp;
        <select
          id="roll_type"
          className="w3-select opt-select"
          name="option"
          value={this.state.roll_type}
          onChange={this.onParamChange}>
          <option value=""></option>
          <option value="wound">
            {this.props.lang == 'en' ? 'wound' : 'blessure'}
          </option>
          <option value="strength">
            {this.props.lang == 'en' ? 'Strength' : 'Force'}
          </option>
        </select>&nbsp;
        {this.props.lang == 'en' ? 'roll of' : 'de'}&nbsp;
        <select
          id="threshold"
        ...
        , {this.props.lang == 'en' ? 'inflicts' : 'inflige'}&nbsp;
        <select
          id="n_mortals"
          value={this.state.n_mortals}
          className="w3-select opt-select"
          name="option"
          onChange={this.onParamChange}>
          <option value=""></option>
  ...
  render() {
    return (
      <div
        ...
        {this.props.lang == 'en' ?
          'scores one additional hit' :
          'génère une touche supplémentaire'}
      </div>
    );
  }
}
